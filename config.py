...
# Email digest (SMTP)
# ---------------------------------------------------------------------------
EMAIL_TO = os.environ.get("EMAIL_TO", "katherine@kodely.io,arissa.kwan@kodely.io,isabella.deeb@kodely.io,servando@kodely.io,jethro@kodely.io,mitzi.yap@kodely.io")
